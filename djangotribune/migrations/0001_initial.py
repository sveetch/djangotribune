...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('target', models.CharField(choices=[('user_agent', 'User Agent'), ('author__username', 'Username'), ('raw', 'Raw message')], max_length=30, verbose_name='target')),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='identified author')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clock', models.TimeField(verbose_name='clock')),
                ...
                ('author', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='identified author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maximised', models.BooleanField(default=True, verbose_name='maximised view')),
